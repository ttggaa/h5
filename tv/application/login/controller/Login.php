...
namespace app\login\controller; use app\XDeode; use think\Controller; class Login extends Controller 
{
	...
	public function share() 
	{
		...
		if($num>0) 
		{
			...
			if($ipnum=='0') 
			{
				db('user')->where('id',$uid)->setInc('sign',15);
		...
		return json(['code'=>1,'msg'=>$dwzapi,'sign'=>rand(5,30),'share'=>$share_ma]);
	}
  ...
  public function vlist() 
	...
	public function pay() 
	{
		...
		if($data['money']=='1'||$data['money']=='8'||$data['money']=='26'||$data['money']=='50'||$data['money']=='88'||$data['money']=='169') 
		{
		}
		else 
		{
			return json(['code'=>1,'msg'=>'恭喜您已经成为代理，有效期一年，请加客服微信287311037，提供您的支付凭证']);
		}
